  ...
  if (!report) return null;
      ...
      return (
        ...
        <>
                              ...
                              <main className="min-h-screen bg-[#FFFBF7] font-sans text-[#1A1A2E] pb-20 scroll-smooth">
                                ...
                                <nav className="sticky top-[65px] lg:top-[70px] z-40 bg-[#FFFBF7]/95 backdrop-blur-md border-b border-[#E8E1D9] py-3 overflow-x-auto no-scrollbar shadow-sm transition-all">
                                    ...
                                    <div className="max-w-6xl mx-auto px-4 flex justify-start md:justify-center gap-6 md:gap-10 min-w-max">
                                        ...
                                        {hair_color_recommendations && <a href="#hair" className="text-sm font-bold text-gray-500 hover:text-primary transition-colors uppercase tracking-wider whitespace-nowrap">Hair</a>}
                              ...
                              <div className="group relative">
                                  ...
                                  <div className="relative bg-white p-3 shadow-xl rounded-2xl">
                                      ...
                                      <div className="w-full rounded-xl overflow-hidden relative bg-gray-50">
                                          ...
                                          {drapingImages.best ? (
                                              ...
                                              <img src={drapingImages.best} alt="Best" className="w-full h-auto max-h-[700px] object-contain mx-auto" />
                                              ...
                                              <div className="w-full aspect-[3/4] bg-gray-100 flex items-center justify-center animate-pulse text-gray-400">Generatiing...</div>
                                  ...
                                  <p className="text-center mt-6 font-serif italic text-gray-600">
                                      ...
                                      &quot;Notice how your skin looks clearer and your eyes brighter.&quot;
                                              ...
                                              <img src={drapingImages.worst} alt="Worst" className="w-full h-auto max-h-[700px] object-contain mx-auto" />
                                              ...
                                              <div className="w-full aspect-[3/4] bg-gray-100 flex items-center justify-center animate-pulse text-gray-400">Generating...</div>
                          ...
                          {palette && (
                              ...
                              <div id="palette" className="bg-white p-10 md:p-16 rounded-[3rem] shadow-sm border border-[#E8E1D9] relative overflow-hidden scroll-mt-20">
                                  ...
                                  <div className="space-y-16 relative z-10">
                                      ...
                                      {worst_colors && worst_colors.length > 0 && (
                                          ...
                                          <div className="mt-16 pt-12 border-t border-dashed border-gray-200">
                                              ...
                                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                  ...
                                                  {worst_colors.map((color: any, idx: number) => (
                                      ...
                                      <div id="hair" className="bg-[#1A1A2E] text-white p-8 rounded-[2rem] shadow-lg relative overflow-hidden scroll-mt-20">
                                          ...
                                          <div className="relative z-10">
                                              ...
                                              <div className="space-y-4">
                                                  ...
                                                  {hair_color_recommendations.map((hair: any, i: number) => (
