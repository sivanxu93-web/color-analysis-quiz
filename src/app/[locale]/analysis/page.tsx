...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  ...
  const description = "Upload your photo for a professional AI seasonal color analysis. Get your personalized palette in seconds with our advanced AI Stylist.";
  
  return {
    title,
    description,
    keywords: ['personal color analysis', 'upload photo for color analysis', 'ai stylist', 'seasonal palette test'],
