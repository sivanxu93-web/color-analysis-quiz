...
export const getSeoText = (slug: string, locale: string = 'en') => {
  ...
  return (
    <div className="space-y-12 text-[#2D2926]">
      {/* 1. What is Season */}
      <div className="space-y-4">
        <h2 className="text-3xl font-serif font-bold text-[#2D2926]">What Is {item.title}? A Complete Guide to This Season</h2>
        <div className="flex flex-wrap gap-3 my-4">
          <span className="px-3 py-1 bg-[#fff8f5] border border-gray-200 rounded-full text-xs font-mono text-gray-500">Hue: {item.hue}</span>
          <span className="px-3 py-1 bg-[#fff8f5] border border-gray-200 rounded-full text-xs font-mono text-gray-500">Value: {item.value}</span>
          <span className="px-3 py-1 bg-[#fff8f5] border border-gray-200 rounded-full text-xs font-mono text-gray-500">Chroma: {item.chroma}</span>
        </div>
      ...
      {/* 2. Color Palette */}
      <div className="space-y-4">
        <h3 className="text-2xl font-serif font-bold text-[#2D2926]">The Complete {item.title} Color Palette</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-serif font-bold text-[#2D2926]">{item.title} Capsule Wardrobe Rules</h3>
        <p className="leading-relaxed text-gray-600">{item.wardrobeRule}</p>
      </div>

      {/* 4. Makeup & Style Guide */}
      <div className="space-y-4">
        <h3 className="text-2xl font-serif font-bold text-[#2D2926]">{item.title} Makeup & Cosmetics Guide</h3>
        <p className="leading-relaxed text-gray-600">{item.makeupGuide}</p>
      </div>

      {/* 5. Celebrities */}
      <div className="space-y-4">
        <h3 className="text-2xl font-serif font-bold text-[#2D2926]">{item.title} Celebrities</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-serif font-bold text-[#2D2926]">{item.title} vs. {item.sibling}</h3>
