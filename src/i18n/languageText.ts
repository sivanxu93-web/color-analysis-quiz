...
export const getColorLabText = async () => {
  ...
  return {
    ...
    MenLanding: {
      title: t('MenLanding.title'),
      description: t('MenLanding.description'),
      h1: t('MenLanding.h1'),
      h2: t('MenLanding.h2'),
      h2_2: t('MenLanding.h2_2'),
      feature1Title: t('MenLanding.feature1Title'),
      feature1Desc: t('MenLanding.feature1Desc'),
      feature2Title: t('MenLanding.feature2Title'),
      feature2Desc: t('MenLanding.feature2Desc'),
      feature3Title: t('MenLanding.feature3Title'),
      feature3Desc: t('MenLanding.feature3Desc'),
    },
    KoreanLanding: {
      title: t('KoreanLanding.title'),
      description: t('KoreanLanding.description'),
      h1: t('KoreanLanding.h1'),
      h2: t('KoreanLanding.h2'),
      h2_2: t('KoreanLanding.h2_2'),
      feature1Title: t('KoreanLanding.feature1Title'),
      feature1Desc: t('KoreanLanding.feature1Desc'),
      feature2Title: t('KoreanLanding.feature2Title'),
      feature2Desc: t('KoreanLanding.feature2Desc'),
      feature3Title: t('KoreanLanding.feature3Title'),
      feature3Desc: t('KoreanLanding.feature3Desc'),
    },
    SixteenSeasonLanding: {
      title: t('SixteenSeasonLanding.title'),
      description: t('SixteenSeasonLanding.description'),
      h1: t('SixteenSeasonLanding.h1'),
      h2: t('SixteenSeasonLanding.h2'),
      h2_2: t('SixteenSeasonLanding.h2_2'),
      feature1Title: t('SixteenSeasonLanding.feature1Title'),
      feature1Desc: t('SixteenSeasonLanding.feature1Desc'),
      feature2Title: t('SixteenSeasonLanding.feature2Title'),
      feature2Desc: t('SixteenSeasonLanding.feature2Desc'),
      feature3Title: t('SixteenSeasonLanding.feature3Title'),
      feature3Desc: t('SixteenSeasonLanding.feature3Desc'),
    },
    Analysis: {
    ...
    Validator: {
      ...
      seoTitle: t('Validator.seoTitle'),
      seoDescription: t('Validator.seoDescription'),
